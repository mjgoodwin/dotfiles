...
superenv executed: clang -pipe -Os -march=native -o conftest -g -O2 conftest.c -lm -isystem/usr/local/include -isystem/usr/include/libxml2 -isystem/System/Library/Frameworks/OpenGL.framework/Versions/Current/Headers -L/usr/local/lib -L/System/Library/Frameworks/OpenGL.framework/Versions/Current/Libraries -Wl,-headerpad_max_install_names
...
superenv executed: clang -pipe -Os -march=native -o conftest -g -O2 conftest.c -ljpeg -lm -isystem/usr/local/include -isystem/usr/include/libxml2 -isystem/System/Library/Frameworks/OpenGL.framework/Versions/Current/Headers -L/usr/local/lib -L/System/Library/Frameworks/OpenGL.framework/Versions/Current/Libraries -Wl,-headerpad_max_install_names
...
clang called with: -o conftest -g -O2 conftest.c -lz -ljpeg -lm
superenv executed: clang -pipe -Os -march=native -o conftest -g -O2 conftest.c -lz -ljpeg -lm -isystem/usr/local/include -isystem/usr/include/libxml2 -isystem/System/Library/Frameworks/OpenGL.framework/Versions/Current/Headers -L/usr/local/lib -L/System/Library/Frameworks/OpenGL.framework/Versions/Current/Libraries -Wl,-headerpad_max_install_names
...
clang called with: -o conftest -g -O2 conftest.c -ltiff -lz -ljpeg -lm
superenv executed: clang -pipe -Os -march=native -o conftest -g -O2 conftest.c -ltiff -lz -ljpeg -lm -isystem/usr/local/include -isystem/usr/include/libxml2 -isystem/System/Library/Frameworks/OpenGL.framework/Versions/Current/Headers -L/usr/local/lib -L/System/Library/Frameworks/OpenGL.framework/Versions/Current/Libraries -Wl,-headerpad_max_install_names
