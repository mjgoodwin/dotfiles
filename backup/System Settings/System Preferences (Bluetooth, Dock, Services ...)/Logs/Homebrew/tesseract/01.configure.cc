...
clang++ called with: -o conftest -g -O2 -I/usr/local/include/leptonica conftest.cpp -llept
superenv executed: clang++ -pipe -Os -march=native -o conftest -g -O2 -I/usr/local/include/leptonica conftest.cpp -llept -isystem/usr/local/include -isystem/usr/include/libxml2 -isystem/System/Library/Frameworks/OpenGL.framework/Versions/Current/Headers -L/usr/local/lib -L/System/Library/Frameworks/OpenGL.framework/Versions/Current/Libraries -Wl,-headerpad_max_install_names
